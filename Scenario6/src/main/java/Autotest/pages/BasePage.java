...
public class BasePage {
    ...
    public WebElement findElementObject(String elementName) {
        ...
        try {
            String locator = JsonPath.read(object_repo_file, "$." + elementName).toString();
            return webUI.findWebElement(locator);
        } catch (PathNotFoundException | IOException e) {
            logger.error("Error reading object repo: {}", e.getMessage());
        }
        return null;
    }
